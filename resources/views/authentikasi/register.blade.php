              ...
              <div class="card mb-3">
                ...
                <a class="nav-link collapsed" href="/">
                  ...
                  <form method="POST" action="{{ route('register') }}" class="row g-3 needs-validation">
                    @csrf
                    <div class="col-12">
                      <label for="name" class="form-label" :value="__('Name')">Nama</label>
                    ...
                    <div class="col-12">
                      <div class="form-check">
                        ...
                        <label class="form-check-label" for="acceptTerms">Saya setuju menerima <a href="#">syarat dan ketentuan</a></label>
                        <div class="invalid-feedback">Anda harus menyetujui sebelum register</div>
                      </div>
                    </div>
                    <div class="col-12">
