...
<body>
    ...
    <!-- Form Section -->
      ...
      <div class="d-flex justify-content-center align-items-center min-vh-100">
        <div class="form-card p-4" style="max-width: 500px; width: 100%; background-color: #90CBC1; border-radius: 8px; color: rgb(0, 0, 0);">
            ...
            <form method="POST" action="{{ route('register') }}">
                ...
                <div class="d-flex justify-content-between align-items-center mt-4">
					...
					<x-primary-button 
    class="main-btn" 
    style="background-color: #FDCDC5; color: black; border: none; padding: 10px 20px; border-radius: 25px; font-weight:; box-shadow: 0px 4px 6px rgba(0, 0, 0, 0.1); transition: all 0.3s ease; font-family: 'Poppins', sans-serif;"
    onmouseover="this.style.backgroundColor='#EBA199'; this.style.transform='scale(1.05)';" 
    onmouseout="this.style.backgroundColor='#FDCDC5'; this.style.transform='scale(1)';"
>
    {{ __('Daftar') }}
</x-primary-button>
