<x-layout>
    ...
    <form class="forms-sample" action="{{ url('dashboard/mahasiswa/update', $mahasiswa->nim) }}" method="POST">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-8">
                <input type="number" class="form-control" id="nim" name="nim" value="{{ $mahasiswa->nim }}" placeholder="Masukkan NIM">
            </div>
        </div>
        <div class="form-group row">
        ...
        <div class="form-group row">
            <label for="rombel_id" class="col-sm-4 col-form-label mb-3">Rombel</label>
            <div class="col-sm-8">
        ...
        <div class="form-group row">
            <label for="prodi_id" class="col-sm-4 col-form-label mb-3">Prodi</label>
            <div class="col-sm-8">
